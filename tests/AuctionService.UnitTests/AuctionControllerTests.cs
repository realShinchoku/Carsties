...
public class AuctionControllerTests
{
    ...
    public AuctionControllerTests()
    {
        ...
        var mockMapper = new MapperConfiguration(cfg => cfg.AddMaps(typeof(MappingProfiles).Assembly)).CreateMapper()
    ...
    public async Task CreateAuction_FailedSave_Returns400BadRequest()
    {
        ...
        Assert.Equal(createdResult.Value, "Could not save changes to database.");
    }
    ...
    public async Task UpdateAuction_WithInvalidGuid_ReturnsNotFound()
    {
        ...
        // act
        var result = await _controller.UpdateAuction(Guid.NewGuid(), null);
